...
public class Company
{
    ...
    private AdmissionProcess admissionProcess = null;

    public void Contract(Employe newEmploye)
    {
        var employe = this.Employes.FirstOrDefault(x => x.Name == newEmploye.Name);
        if (employe == null)
            return;
        AdmissionArgs args = new AdmissionArgs();
        args.Employe = employe;
        args.Company = this;
        admissionProcess.Apply(args);
    ...
    public class CompanyBuilder
    {
        ...
        public CompanyBuilder SetFactory(IProcessFactory factory)
        {
            ...
            company.admissionProcess = factory.CreateAdmissionProcess();
            return this;
        }
